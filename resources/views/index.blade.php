...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('asset/css/font-awesome.min.css') }}" />
    {{-- <link rel="stylesheet" href="{{ secure_asset('asset/css/font-awesome.css') }}" /> --}}
    <!-- site css -->
    ...
    <!-- fancy box js -->
    <link rel="stylesheet" href="{{ secure_asset('asset/css/jquery.fancybox.css') }}" />
    <!--[if lt IE 9]>
...
<body class="dashboard dashboard_1">
    ...
    <!-- owl carousel -->
    <script src="{{ secure_asset('asset/js/owl.carousel.js') }}"></script>
    <!-- chart js -->
    <script src="{{ secure_asset('asset/js/Chart.min.js') }}"></script>
    <script src="{{ secure_asset('asset/js/Chart.bundle.min.js') }}"></script>
    <script src="{{ secure_asset('asset/js/utils.js') }}"></script>
    <script src="{{ secure_asset('asset/js/analyser.js') }}"></script>
    <!-- nice scrollbar -->
    {{-- <script src="{{ secure_asset('asset/js/perfect-scrollbar.min.js') }}"></script> --}}
    <script>
        var ps = new PerfectScrollbar('#sidebar');
    </script>
    <script src="{{ secure_asset('asset/js/jquery-3.3.1.min.js') }}"></script>
    <script src="{{ secure_asset('asset/js/jquery.fancybox.min.js') }}"></script>
    <!-- custom js -->
    <script src="{{ secure_asset('asset/js/custom.js') }}"></script>
    <script src="{{ secure_asset('asset/js/chart_custom_style1.js') }}"></script>
    <!-- calendar file css -->
    <script src="{{ secure_asset('asset/js/semantic.min.js') }}"></script>
